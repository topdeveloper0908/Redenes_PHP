    ...
    <div class="container">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex justify-content-center align-items-center bg-one-image">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user">
                                ...
                                <div class="form-group">
                                    <input type="number" class="form-control form-control-user" id="Phone" name="Phone" placeholder="Cell Phone Number" required>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" class="form-control form-control-user" placeholder="Date of Birth" id="Date" name="Date" required>
                                    </div>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $("form").submit(function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "https://api.redenes.org/dev/v1/register-user/",

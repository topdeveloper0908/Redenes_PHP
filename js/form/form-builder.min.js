            ...
            var T = function(t, n) {
              ...
              , B = function(t) {
                var r, n = t.type, o = [], i = function(e) {
                    ...
                    action1: function() {
                        return "<div class='form-group buttonColor-wrap'><label>Action1</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option>Action1</option><option>Action2</option><option>Action3</option></select></div></div>";
                    },
                    action2: function() {
                        return "<div class='form-group buttonColor-wrap'><label>Action2</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option>Action1</option><option>Action2</option><option>Action3</option></select></div></div>";
                    },
                    action3: function() {
                        return "<div class='form-group buttonColor-wrap'><label>Action3</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option>Action1</option><option>Action2</option><option>Action3</option></select></div></div>";
                    },
                    action4: function() {
                        return "<div class='form-group buttonColor-wrap'><label>Action4</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option>Action1</option><option>Action2</option><option>Action3</option></select></div></div>";
                    },
                    name: function(e) {
                        return H("name", t, e)
                    },

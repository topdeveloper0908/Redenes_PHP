            ...
            var T = function(t, n) {
              ...
              , B = function(t) {
                var r, n = t.type, o = [], i = function(e) {
                    ...
                    textColor: function() {
                        return "<div class='form-group textColor-wrap'><label>TextColor</label><div class='input-wrap'><input name='textColor' class='fld-textColor form-control' type='color'></div></div>";
                    },
                    preFilled: function() {
                        return H("preFilled", t)
                    },
                    buttonColor: function() {
                        return "<div class='form-group buttonColor-wrap'><label>ButtonColor</label><div class='input-wrap'><input name='buttonColor' class='fld-buttonColor form-control' type='color'></div></div>";
                    },
                    name: function(e) {
                        return H("name", t, e)
                    },

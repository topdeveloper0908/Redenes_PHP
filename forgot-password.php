                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">We get it, stuff happens. Just enter your Cell Phone Number below
                                            and we'll send you a link to reset your password!</p>
                                    </div>
                                    <form class="user">
                                        <div class="form-group">
                                            <input type="phone" class="form-control form-control-user" id="phone" name="phone" aria-describedby="emailHelp" placeholder="Enter Phone Number..." required>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $("form").submit(function(event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "https://api.redenes.org/dev/v1/forgot-password/",

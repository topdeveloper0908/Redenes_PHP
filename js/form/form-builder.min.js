            ...
            var T = function(t, n) {
              ...
              , B = function(t) {
                var r, n = t.type, o = [], i = function(e) {
                    ...
                    action1: function() {
                        return "<div class='form-group action1-wrap'><label>Action1</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option value='action1'>Action1</option><option value='action2'>Action2</option><option value='action3'>Action3</option></select></div></div>";
                    },
                    action2: function() {
                        return "<div class='form-group action2-wrap'><label>Action2</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option value='action1'>Action1</option><option value='action2'>Action2</option><option value='action3'>Action3</option></select></div></div>";
                    },
                    action3: function() {
                        return "<div class='form-group action3-wrap'><label>Action3</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option value='action1'>Action1</option><option value='action2'>Action2</option><option value='action3'>Action3</option></select></div></div>";
                    },
                    action4: function() {
                        return "<div class='form-group action4-wrap'><label>Action4</label><div class='input-wrap'><select class='custom-select form-control-sm w-100'><option value='action1'>Action1</option><option value='action2'>Action2</option><option value='action3'>Action3</option></select></div></div>";
                    },
                    name: function(e) {
                        return H("name", t, e)
                    },
